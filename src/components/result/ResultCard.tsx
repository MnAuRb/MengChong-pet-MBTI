...
export default function ResultCard() {
  ...
  return (
    <motion.div
      className="flex flex-col gap-5 w-full lg:grid lg:grid-cols-[40%_1fr] lg:gap-8 lg:items-start"
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="text-center lg:text-left">
          ...
          <div className="bg-warm-light rounded-2xl px-6 py-5 shadow-sm">
            <h1 className="text-3xl lg:text-4xl font-bold text-warm-dark tracking-wider">
              {result.type}
            </h1>
